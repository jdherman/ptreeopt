...
for maxdepth in range(1,10):
  ...
  model = Folsom('folsom-daily-w2016.csv', sd='1995-10-01', ed='2016-09-30', use_tocs = False)
  ...
  pickle.dump(snapshots, open('output/snapshots-opt-depth-' + str(maxdepth) + '-seed-' + str(comm.rank) + '.pkl', 'wb'))
