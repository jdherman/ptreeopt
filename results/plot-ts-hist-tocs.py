...
snapshots = pickle.load(open('results/hist-tocs/snapshots-tocs-depth-4-seed-23.pkl', 'rb'))
...
model = Folsom('folsom/data/folsom-daily-w2016.csv', sd='1995-10-01', ed='2016-09-30', use_tocs = True)
...
plt.title('(c) Storage Trajectory, TAF', family='OfficinaSanITCMedium', loc='left')
plt.legend(['Observed', 'Tree', 'DDP', 'SDP'], loc=3, ncol=4, bbox_to_anchor=(0.35 , 0.97))
plt.ylim([0,1000])
