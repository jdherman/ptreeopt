...
annQs = pd.read_csv('folsom-cc-annQ-MA50.csv', index_col=0, parse_dates=True)
lp3s = pd.read_csv('folsom-cc-lp3-kcfs.csv', index_col=0, parse_dates=True)
wycents = pd.read_csv('folsom-cc-wycentroid.csv', index_col=0, parse_dates=True)
